      ...
      <el-main height="100%">
        <div class="card main-top-menus">
          <div v-for="(app, index) in staticData.appList" :key="index">
            <div
              class="top-icon"
              @click="index !== 0 ? open(app.link) : void 0"
            >
              <icon :type="app.icon" />
              <div>
                {{ app.name }}
                ...
                <div class="digit-road data-total">
                  <el-row style="overflow: hidden">
                    <el-col :span="11">
                      <div>
                        <h3
                          style="font-size: 16px; margin: 20px 0 0; padding: 0"
                        >
                          养管里程
                        </h3>
                        <div>
                          <span class="blue-num">{{
                            digitNums.totlalLeftMil
                          }}</span>
                          <span> 公里 </span>
                          <span class="blue-num">{{
                    ...
                    <el-row style="height: calc(100% - 67px)">
                      ...
                      >
                        <div
                          ...
                          "
                        >
                          <div class="blue-num" style="line-height: 1.5">
                            2600
                          </div>
                          <span>相关企业(个)</span>
                        </div>
